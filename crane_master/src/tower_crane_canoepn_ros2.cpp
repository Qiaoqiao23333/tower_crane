...
private:
    ...
    int32_t velocity_to_pulse(float velocity_deg_per_sec)
    {
        ...
        int32_t velocity_pulse_per_sec = static_cast<int32_t>((velocity_deg_per_sec / 360.0f) * ENCODER_RESOLUTION);
    ...
    {
        int32_t acceleration_pulse_per_sec2 = static_cast<int32_t>((acceleration_deg_per_sec2 / 360.0f) * ENCODER_RESOLUTION);
